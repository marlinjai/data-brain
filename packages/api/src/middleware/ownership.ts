...
export async function verifyTableOwnership(c: Context<AppEnv>, adapter: DatabaseAdapter, tableId: string) {
...
export async function verifyRowOwnership(c: Context<AppEnv>, adapter: DatabaseAdapter, rowId: string) {
...
export async function verifyColumnOwnership(c: Context<AppEnv>, adapter: DatabaseAdapter, columnId: string) {
