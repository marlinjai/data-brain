...
summary: Version history for Data Brain structured data API service, covering releases from v0.1.0 through v0.2.0 including multi-tenant workspace management, 40 DatabaseAdapter methods over REST, SDK, and self-hosting support.
category: changelog
...
- `@data-brain/api` — Cloudflare Workers API (Hono) with full DatabaseAdapter coverage
  ...
  - 40 DatabaseAdapter methods exposed over HTTP
...
[0.3.0]: https://github.com/marlinjai/data-brain/compare/v0.2.0...v0.3.0
